...
if ( !class_exists( 'WelocallyPlacesPremium' ) ) {
	/**
	 * Main plugin  
	 */
	class WelocallyPlacesPremium {
	    ...
	    static function placeCategory() {
			return get_cat_ID( WelocallyPlacesPremium::CATEGORYNAME );
	    }
	    
	    static function wl_places_version() {
			return WelocallyPlacesPremium::VERSION ;
	    }
		...
		public function in_place_category() {
			if( is_category( WelocallyPlacesPremium::CATEGORYNAME ) ) {
				return true;
			}
			$cat_id = get_query_var( 'cat' );
		...
		public function loadDomainStylesScripts() {
			...
			//welocally
			wp_enqueue_script('wl_base_script', WP_PLUGIN_URL.'/welocally-places/resources/javascripts/wl_base.js', array('jquery'), WelocallyPlacesPremium::VERSION);
			wp_enqueue_script('wl_place_widget_script',  WP_PLUGIN_URL.'/welocally-places/resources/javascripts/wl_place_widget.js', array('jquery'), WelocallyPlacesPremium::VERSION);
			wp_enqueue_script('wl_infobox_script', WP_PLUGIN_URL.'/welocally-places/resources/javascripts/wl_infobox.js', array('jquery'), WelocallyPlacesPremium::VERSION);
			wp_enqueue_script('wl_places_multi_script', WP_PLUGIN_URL.'/welocally-places/resources/javascripts/wl_places_multi_widget.js', array('jquery'), WelocallyPlacesPremium::VERSION);
			...
			if( class_exists('WelocallyPlacesPremiumCustomize' ) 
				...
				if(file_exists($target_path.'/wl_places.css'))  {
					...
					wp_enqueue_style( 'wl_places',WP_PLUGIN_URL.'/welocally-places/resources/stylesheets/wl_places.css', array(), WelocallyPlacesPremium::VERSION, 'screen' );
				...
				if(file_exists($target_path.'/wl_places_place.css'))  {
					...
					wp_enqueue_style( 'wl_places_place',WP_PLUGIN_URL.'/welocally-places/resources/stylesheets/wl_places_place.css', array(), WelocallyPlacesPremium::VERSION, 'screen' );
				...
				if(file_exists($target_path.'/wl_places_multi.css'))  {
					...
					wp_enqueue_style( 'wl_places_multi',WP_PLUGIN_URL.'/welocally-places/resources/stylesheets/wl_places_multi.css', array(), WelocallyPlacesPremium::VERSION, 'screen' );			
		...
		public function loadAdminDomainStylesScripts() {
			...
			//welocally
			wp_enqueue_script('wl_placefinder_widget_script', WP_PLUGIN_URL.'/welocally-places/resources/javascripts/wl_placefinder_widget.js', array('jquery'), WelocallyPlacesPremium::VERSION);
			wp_enqueue_script('wl_addplace_widget_script', WP_PLUGIN_URL.'/welocally-places/resources/javascripts/wl_addplace_widget.js', array('jquery'), WelocallyPlacesPremium::VERSION);
			wp_enqueue_script('wl_register_widget_script', WP_PLUGIN_URL.'/welocally-places/resources/javascripts/wl_register_widget.js', array('jquery'), WelocallyPlacesPremium::VERSION);
			...
			wp_enqueue_style( 'wl_places_finder_style',WP_PLUGIN_URL.'/welocally-places/resources/stylesheets/wl_places_finder.css',array(), WelocallyPlacesPremium::VERSION, 'screen' );				
			wp_enqueue_style( 'wl_places_addplace_style',WP_PLUGIN_URL.'/welocally-places/resources/stylesheets/wl_places_addplace.css',array(), WelocallyPlacesPremium::VERSION, 'screen' );	
			wp_enqueue_style( 'wl_places_admin_style',WP_PLUGIN_URL.'/welocally-places/resources/stylesheets/wl_places_admin.css',array(), WelocallyPlacesPremium::VERSION, 'screen' );	
			wp_enqueue_style( 'wl_places_wp_style',WP_PLUGIN_URL.'/welocally-places/resources/stylesheets/wl_places_wp.css',array(), WelocallyPlacesPremium::VERSION, 'screen' );	
		}
		...
		public function replaceTagsInContent($content) {
            return WelocallyPlacesPremium_Tag::searchAndReplace($content, array($this, 'addTagMarkup'));
		}
		...
		public function getCategoryMapMarkup(
			...
			$options = $this->getOptions();
			$custom_style=null;
			if(class_exists('WelocallyPlacesPremiumCustomize' ) && isset($options[ 'map_custom_style' ])  && $options[ 'map_custom_style' ]!=''){
			...
			if(class_exists('WelocallyPlacesPremiumCustomize' ) && isset($options[ 'map_default_marker' ])  && $options[ 'map_default_marker' ]!=''){
		...
		public function create_category_if_not_exists( ) {
			if ( !category_exists( WelocallyPlacesPremium::CATEGORYNAME ) ) {
				$category_id = wp_create_category( WelocallyPlacesPremium::CATEGORYNAME );
				return $category_id;
			} else {
        ...
        public function tagHandling($post_id) {
            if (!wp_is_post_revision($post_id)) {
                ...
                $tags = WelocallyPlacesPremium_Tag::parseText($post->post_content);

                $proc = new WelocallyPlacesPremium_TagProcessor();
        ...
        public function getOptions() {
            $this->latestOptions = get_option(WelocallyPlacesPremium::OPTIONNAME, array());
        ...
        public function saveOptions($options) {
           update_option(WelocallyPlacesPremium::OPTIONNAME, $options);
           $this->latestOptions = $options;
        }
        
        public function deleteOptions() {
            delete_option(WelocallyPlacesPremium::OPTIONNAME);
        }
	...
	global $wlPlaces;
	$wlPlaces = new WelocallyPlacesPremium();
}
?>
