...
*/
function PLACEHOUND_GeoDbSearch (cfg) {		
...
PLACEHOUND_GeoDbSearch.prototype.search = function() {
	...
	jQuery.ajax({
			  ...
			  success: function(data) {
				...
				if(data != null && data.errors != null) {
					...
					//set the titlelink for each
					jQuery.each(data, function(i,place) {
						place.properties.titlelink = _instance.cfg.baseUrl+'/place.html?id='+place._id;
