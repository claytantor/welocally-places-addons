...
function PLACEHOUND_PlaceFinderWidget (cfg) {
	this.cfg;
	this.geocoder;	
	this.searchLocation;
	this.statusArea;
...
PLACEHOUND_PlaceFinderWidget.prototype.initCfg = function(cfg) {
	var errors = [];
	if (!cfg) {
...
PLACEHOUND_PlaceFinderWidget.prototype.makeWrapper = function() {
	// Build Widget
	var _instance = this;
	...
	//the selector
	_instance.cfg.placeSelector.initCfg({
		id: 'wl_selector_place_1',
		hidePlaceSectionMap: true,
		imagePath: 'images/marker_all_base.png'
	});
	_instance.multiPlacesWidget.getSelectedArea().append(_instance.cfg.placeSelector.makeWrapper());
...
PLACEHOUND_PlaceFinderWidget.prototype.locationFieldInputHandler = function(event) {
...
PLACEHOUND_PlaceFinderWidget.prototype.searchHandler = function(event) {
	...
	if(_instance.selectedPlace.geometry.coordinates[1] && _instance.selectedPlace.geometry.coordinates[0]){
		...
		_instance.searcher = 
			 new PLACEHOUND_GeoDbSearch({
			   baseUrl:_instance.cfg.baseUrl,	
...
PLACEHOUND_PlaceFinderWidget.prototype.getSelectedArea = function() { 
	return this.multiPlacesWidget.getSelectedArea();
};

PLACEHOUND_PlaceFinderWidget.prototype.setStatus = function(statusArea, message, type, showloading){
	var _instance  = this;
...
PLACEHOUND_PlaceFinderWidget.prototype.validGeocodeForSearch = function (geocode) {
...
PLACEHOUND_PlaceFinderWidget.prototype.hasType = function(type_name, address_components){
...
PLACEHOUND_PlaceFinderWidget.prototype.getShortNameForType = function(type_name, address_components){
	for (componentIndex in address_components) {
		var component = address_components[componentIndex];
		if(component.types[0] == type_name)
...
PLACEHOUND_PlaceFinderWidget.prototype.triggerResize = function(){
	var _instance = this;
